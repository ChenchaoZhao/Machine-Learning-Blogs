...
Let $$f$$ and $$g$$ be functions in [Reproducing kernel Hilbert space](https://en.wikipedia.org/wiki/Reproducing\_kernel\_Hilbert\_space) (RKHS) $$\mathcal H$$, then the inner product is denoted $$\langle f, g \rangle_\mathcal H$$ .
